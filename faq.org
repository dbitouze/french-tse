...
les « [[#custom-id-mise-en-forme][codes « *hors texte* »]] » sont *à proscrire*
dans les commentaires (cf. la question
« [[#custom-id-commentaires-invisibles][Une contribution est indiquée comme
agrémentée d'un certain nombre de commentaires mais tous ne sont pas
visibles. Pourquoi ?]] »).

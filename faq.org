...
Ce sont des liens qui mènent au profil de celui à qui s'adresse le commentaire.

Cela présentent plusieurs avantages :
1. si plusieurs personnes ont commenté avant vous la contribution, on sait ainsi
   à qui s'adresse le vôtre ;
2. la personne à qui vous vous adressez pourra être informée du commentaire que
   vous lui adressez (selon la configuration des notifications par courriel
   qu'elle aura choisie).

Pour y recourir, saisissez simplement « =@= » suivi du nom qui apparaît en
signature du commentaire que vous vous apprêtez à commenter.

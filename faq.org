...
3. N'hésitez pas à [[sec:peaufinage][*modifier* vos contributions]] *pour* les *peaufiner*.

*** <<sec:peaufinage>>Je viens de constater que ma contribution n'a pas été très clairement formulée. Puis-je la modifier ?
...
La production d'un ECM est un exercice certes difficile (surtout au début), mais

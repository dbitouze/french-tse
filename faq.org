...
- Si vous possédez déjà un [[http://openid.net/get-an-openid/what-is-openid/][OpenID]], vous pouvez [[https://texnique.fr/osqa/compte/connexion/][directement vous connecter au
  site]] par ce biais-là.
- Sinon, vous devez vous créer préalablement un [[https://texnique.fr/osqa/compte/local/inscription/][nouveau compte]].
...
courriel, vous pouvez le faire [[https://texnique.fr/osqa/compte/valider/][ici]].  Si vous n'êtes pas encore membre de cette
communauté, vous pouvez la rejoindre en vous [[https://texnique.fr/osqa/compte/local/inscription/][inscrivant]].
...
- [[https://texnique.fr/osqa/questions/][trouvant une question]] à laquelle répondre ;
- [[https://texnique.fr/osqa/questions/demandez/][posant une question]].
...
6. or la solution à *X* est en fait *Z* (qui n'a rien à voir avec *Y*) !
...
À ce sujet, n'hésitez pas à placer une capitale initiale au premier mot du titre.
...
[[http://ctan.org/pkg/mwe][=mwe=]] qui :

- fournit des images dont les autres disposeront également ;
- inclut le package [[http://mirrors.ctan.org/macros/latex/contrib/lipsum/lipsum.pdf][=lipsum=]] permettant l'inclusion de faux-texte, ce qui peut
  être utile.

Et n'oubliez pas : « Aide-toi, [[https://texnique.fr/][texnique.fr]] t'aidera. » :-)
...
*Attention !* La classe =standalone= avec l'option =convert= ne doit pas être
employée avec le package =geometry=.

Au cas où cette méthode échoue (ou ne soit pas adaptée en raison de
l'avertissement ci-dessus), [[http://tex.stackexchange.com/q/11866/18401][d'autres possibilités existent]].
...
[[https://texnique.fr/osqa/contact/][bienvenues]] !), il est demandé aux

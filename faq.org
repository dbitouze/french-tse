...
- Si vous possédez déjà un [[http://openid.net/get-an-openid/what-is-openid/][OpenID]], vous pouvez [[https://texnique.fr/osqa/account/signin/][directement vous connecter au
  site]] par ce biais-là.
- Sinon, vous devez vous créer préalablement un [[https://texnique.fr/osqa/account/local/register/][nouveau compte]].
...
communauté, vous pouvez la rejoindre en vous [[https://texnique.fr/osqa/account/local/register/][inscrivant]].
...
- [[https://texnique.fr/osqa/questions/ask/][posant une question]].

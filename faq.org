...
3. Si possible, *illustrez* vos questions et réponses d'un ou plusieurs *[[#custom-id-ecm][ECM]]*...
   voire d'[[#custom-id-image-pdf-dvi][images illustrant ces ECM]].
4. N'hésitez pas à [[#custom-id-peaufinage][*modifier* vos contributions]] *pour* les *peaufiner*.

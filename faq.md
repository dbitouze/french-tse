...
<ul>
<li><a href="#orgheadline9">1. À propos de ce site</a>
<ul>
...
<ul>
<li><a href="#orgheadline10">2.1.1. Comment rendre mes contributions aussi utiles que possible ?</a></li>
...
<li><a href="#orgheadline14">2.2.3. On me demande de reformuler le titre de ma question sous forme interrogative. Pourquoi ?</a></li>
<li><a href="#custom-id-ecm">2.2.4. Qu&rsquo;est-ce qu&rsquo;un ECM et pourquoi est-il si important d&rsquo;en fournir un ?</a></li>
<li><a href="#orgheadline15">2.2.5. Que dois-je faire quand une réponse à ma question a été postée ?</a></li>
<li><a href="#orgheadline16">2.2.6. J&rsquo;ai accepté une réponse à ma question mais une autre qui vient d&rsquo;être publiée est également satisfaisante. Pourquoi ne puis-je pas l&rsquo;accepter aussi ?</a></li>
</ul>
</li>
...
<ul>
<li><a href="#orgheadline21">2.4.1. Quel type de commentaires puis-je poster ici ?</a></li>
<li><a href="#custom-id-commentaire-reponse">2.4.2. En quoi un commentaire diffère-t-il d&rsquo;une réponse ?</a></li>
<li><a href="#orgheadline22">2.4.3. Qu&rsquo;est-ce que ces « <code>@⟨nom⟩</code> » qui introduisent les commentaires et pourquoi devrais-je y recourir ?</a></li>
</ul>
</li>
</ul>
</li>
...
<ul>
<li><a href="#orgheadline24">3.1. Comment mettre en forme ma contribution ?</a></li>
<li><a href="#orgheadline25">3.2. Comment insérer le (un extrait de) code d&rsquo;un fichier <code>.tex</code> (ou autre) ?</a></li>
<li><a href="#orgheadline26">3.3. Dans un paragraphe de texte, comment faire ressortir une commande (La)TeX ou le nom d&rsquo;un package ?</a></li>
<li><a href="#orgheadline27">3.4. Dans une liste, comment ajouter un nouvel item et comment en sortir ?</a></li>
...
<li><a href="#orgheadline29">4. Divers</a>
<ul>
<li><a href="#orgheadline28">4.1. À part lire ou poster des questions, réponses et commentaires, que puis-je faire ici ?</a></li>
...
# À propos de ce site<a id="orgheadline9"></a>
...
## Qu&rsquo;est-ce qu&rsquo;un « gravatar » ?<a id="orgheadline5"></a>
...
## Pourquoi les notifications par courriel sont-elles si importantes ?<a id="orgheadline6"></a>
...
## Comment modifier mon profil, par exemple mes notifications par courriel ?<a id="orgheadline7"></a>
...
### Comment rendre mes contributions aussi utiles que possible ?<a id="orgheadline10"></a>
...
2.  Si possible, **illustrez** vos questions et réponses d&rsquo;un ou plusieurs **[ECM](#custom-id-ecm)**&#x2026;
    voire d&rsquo;[images illustrant ces ECM](#custom-id-image-pdf-dvi).
3.  N&rsquo;hésitez pas à [**modifier** vos contributions](#custom-id-peaufinage) **pour** les **peaufiner**.
...
### On me demande de reformuler le titre de ma question sous forme interrogative. Pourquoi ?<a id="orgheadline14"></a>
...
### Quel type de commentaires puis-je poster ici ?<a id="orgheadline21"></a>
...
### Qu&rsquo;est-ce que ces « `@⟨nom⟩` » qui introduisent les commentaires et pourquoi devrais-je y recourir ?<a id="orgheadline22"></a>
...
## Comment mettre en forme ma contribution ?<a id="orgheadline24"></a>
...
## Comment insérer le (un extrait de) code d&rsquo;un fichier `.tex` (ou autre) ?<a id="orgheadline25"></a>
...
## Dans un paragraphe de texte, comment faire ressortir une commande (La)TeX ou le nom d&rsquo;un package ?<a id="orgheadline26"></a>
...
## Dans une liste, comment ajouter un nouvel item et comment en sortir ?<a id="orgheadline27"></a>
...
# Divers<a id="orgheadline29"></a>

## À part lire ou poster des questions, réponses et commentaires, que puis-je faire ici ?<a id="orgheadline28"></a>

...
Permettre aux membres expérimentés de cette communauté de remanier les questions
et réponses améliore la qualité globale de la base de connaissances de ce
site. Ainsi, les visiteurs de ce site y trouveront beaucoup de questions bien
posées et des réponses clairement formulées.
...
* Changer les mots-clés d'une question → |REP_TO_RETAG|
...
* lorsque les autres membres affichent de nouvelles questions, des réponses, ou
  des commentaires dans leur domaine d'intérêt.
...
courriel, vous pouvez le faire [ici](/osqa/compte/valider/ "Validation de
l'adresse courriel"). Si vous n'êtes pas encore membre de cette communauté, vous
pouvez la rejoindre en vous [inscrivant](/osqa/compte/local/inscription/ "Créez
un compte").
...
* [trouvant une question](/osqa/questions/) à laquelle répondre ;
* [posant une question](/osqa/questions/demandez/).
...
recommandations et astuces, tant pour le [fond](#fond-des-contributions) que
pour la [forme](#forme-des-contributions) des contributions.

# <a name="fond-des-contributions"></a>Fond des contributions
...
* Veillez à *ne pas confondre* **réponses** et **commentaires** : la zone de texte
  ...
  veillez à utiliser les *commentaires* en cliquant sur le lien « ajouter un
  commentaire » sous la question ou la réponse correspondante.
...
* **Questions ou réponses : ** Dans les zones dédiées aux questions ou réponses, une mise en forme basique du
  texte est possible et facilitée par des boutons (et raccourcis claviers) :
    * **gras** :
    ...
    * **liste numérotée** :
        ...
        * syntaxe : cf. [http://daringfireball.net/projects/markdown/syntax#list](http://daringfireball.net/projects/markdown/syntax#list)
    * **liste non numérotée** :
        * raccourci : <kbd>Ctrl</kbd>+<kbd>u</kbd>
        * syntaxe : cf. [http://daringfireball.net/projects/markdown/syntax#list](http://daringfireball.net/projects/markdown/syntax#list)
    * **sous-section/section** (non numérotées) :
    ...
    * **filet horizontal** :
        ...
        * syntaxe : `---`
* **Commentaires** Dans les zones de texte dédiées aux commentaires, les boutons et raccourcis
  ne sont pas disponibles mais il est toujours possible de metre en forme
  soi-même au moyen de la syntaxe indiquée ci-dessus.



Dans **tous les cas**, il est possible d'annuler et de rétablir ce qui vient d'être fait au moyen des
raccourcis :
...
Pour insérer le code d'un fichier `.tex` (ou autre) dans une zone de texte
dédiée aux questions ou réponses, il suffit de :
...
ci-dessus),
[d'autres possibilités existent](http://tex.stackexchange.com/q/11866/18401).
